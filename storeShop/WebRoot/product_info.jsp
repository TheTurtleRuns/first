		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						<div><strong>商品名称:&nbsp;&nbsp;&nbsp;<span style="color:red">${product.pname }</span></strong></div>
						<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
							<div>商品编号:&nbsp;&nbsp;&nbsp;<span style="color:red">${product.pid }</span></div>
						</div>

						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${product.shop_price }元/台 </strong> 市场价： <del>￥${product.market_price }元/台</del>
						</div>
				...
				<div style="width:950px;margin:0 auto;">
					...
					<div style="background-color:#d3d3d3;width:900px;margin-top: 10px">
						<table class="table table-bordered">
							<tbody>
								<tr class="active">
